...
execute in minecraft:overworld run data modify block 29999984 0 43378 Items[] set from storage signshops:ops Items
execute in minecraft:overworld run loot replace entity @s weapon.mainhand 1 mine 29999984 0 43378 air{drop_contents:1b}
