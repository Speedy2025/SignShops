...
# Description:
#   <> Sets the item to Sell (DOES NOT STOCK)
...
data modify storage suso.str:io in.callback set value 'function signshops:operations/interact/init/sell/verify/root'
function suso.str:call
#Output is ["3","6","0","}","0","0","0","0"]