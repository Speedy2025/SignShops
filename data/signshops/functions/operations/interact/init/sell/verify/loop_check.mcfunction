## LOOP INPUT CHECK FOR Sell SIGN FUNCTION
# Context: None
# Calls:
...
execute if score #price5 ss.matches matches 1 unless score #price4 ss.matches matches 10.. run function signshops:operations/interact/init/sell/verify/loop_check