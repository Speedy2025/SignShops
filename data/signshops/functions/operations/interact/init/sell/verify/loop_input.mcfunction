## LOOP INPUT sell SIGN FUNCTION
# Context: None
# Calls:
#   - signshops:operations/interact/init/sell/verify/loop_check
# Called by:
...
function signshops:operations/interact/init/sell/verify/loop_check
...
execute unless score #failed ss.matches matches 1 if score #price4 ss.matches matches 10.. run function signshops:operations/interact/init/sell/verify/invalid
...
execute if score #price3 ss.matches matches 1.. if score #price4 ss.matches matches 0..9 run function signshops:operations/interact/init/sell/verify/loop_input