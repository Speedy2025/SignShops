## ROOT VERIFY BUY SIGN FUNCTION
# Context: None
# Calls:
#   - signshops:operations/interact/init/buy/verify/invalid
...
execute if score #price1 ss.matches matches 1 run function signshops:operations/interact/init/buy/verify/invalid
execute unless score #failed ss.matches matches 1 if score #price2 ss.matches matches 1 run function signshops:operations/interact/init/buy/verify/invalid
execute unless score #failed ss.matches matches 1 if score #price3 ss.matches matches 0 run function signshops:operations/interact/init/buy/verify/invalid

execute if score #price1 ss.matches matches 0 if score #price2 ss.matches matches 0 if score #price3 ss.matches matches 1.. run function signshops:operations/interact/init/buy/verify/loop_input
execute unless score #failed ss.matches matches 1 if score #priceF ss.matches matches 0 run function signshops:operations/interact/init/buy/verify/invalid
execute if score #priceF ss.matches matches 1.. as @e[tag=ss.target,limit=1] at @s run function signshops:operations/interact/init/buy/verify/valid
